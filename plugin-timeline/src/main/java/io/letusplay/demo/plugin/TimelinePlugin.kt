...
import io.letusplay.demo.plugin.timeline.TimelineFragFactory

class TimelinePlugin : ModulePlugin() {

  override fun init() {
    Bumblebee.get()
        .register(
            ITimelineFragFactory::class.java,
            TimelineFragFactory
        )
  }

  companion object {
    val instance = TimelinePlugin()
  }
